                ...
                <table class="table">
                    ...
                    <tbody style="border:1px solid #ccc;border-radius:5px;">
                        <tr v-if="data_show_product_cart.length == 0">
                            <h5 style="color:red;border:1px solid #ccc;border-radius:5px;">Không có sản phẩm nào trong giỏ hàng !</h5>
                        </tr>
            ...
            <div class="col-lg-4">
                <div style="border:1px solid #ccc;padding:10px;border-radius:10px;">
                    ...
                    <router-link to="/order">
                        <button type="button" class="btn btn-info text-white fw-bold" style="width:100%;background-color:blue;">THANH TOÁN</button>
                    </router-link>
                </div>
            </div>
        </div>
