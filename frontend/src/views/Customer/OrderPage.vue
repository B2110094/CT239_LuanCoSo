...
<template>
    <div class="container" style="margin-top:50px;">
        ...
        <div class="row">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="align-items: center;">
                        <li class="breadcrumb-item">
                            <router-link to="/cartStore" style="color:black">Giỏ hàng </router-link>
                        </li>
            ...
            <!-- Right_page -->
            <div class="col-lg-5" style="border:1px solid red;border-radius:10px;">
                <div class="row" style="display:flex;flex-wrap:nowrap;padding:20px;" v-for="item in dataShowFromCart">
                    <div>
                        ...
                        <span style="color:red">&nbsp;(SL: {{ item.quantity_product }})</span>
                    </div>
                    <div style="margin-left:-100px; font-weight:bold;line-height: 71px;">
