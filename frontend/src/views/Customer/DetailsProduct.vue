...
<template>
    <div class="container" id="main_page_detail_product">
        ...
        <div class="row">
            <div class="col-6">
                <img :src="DetailProductData.img_url[0]" class="img-fluid" alt="..." width="300" height="400" style="border: 1px solid #ccc;border-radius: 10px;padding: 10px;box-shadow: 1px 2px 13px 0px;margin-left:160px;">
                <div class="row d-flex mt-5 text-center">
                    <div class="col">
                        <img @click="openImg(DetailProductData.img_url[0], 0)" :src="DetailProductData.img_url[0]" class="img-thumbnail img_introduce" alt="..." width="319" height="444" style="border: 1px solid #ccc;object-fit:contain;border-radius: 10px;padding: 10px;box-shadow: 1px 2px 13px 0px; width:150px;height:150px;margin-right: -10px;">
                    </div>
                    <div class="col">
                        <img @click="openImg(DetailProductData.img_url[1], 1)" :src="DetailProductData.img_url[1]" class="img-thumbnail img_introduce" alt="..." width="319" height="444" style="border: 1px solid #ccc;object-fit:contain;border-radius: 10px;padding: 10px;box-shadow: 1px 2px 13px 0px; width:150px;height:150px;margin-right: 20px;">
                    </div>
                    <div class="col">
                        <img @click="openImg(DetailProductData.img_url[2], 2)" :src="DetailProductData.img_url[2]" class="img-thumbnail img_introduce" alt="..." width="319" height="444" style="border: 1px solid #ccc;object-fit:contain;border-radius: 10px;padding: 10px;box-shadow: 1px 2px 13px 0px; width:150px;height:150px;margin-left: -50px;">
                    </div>
                </div>
            </div>
            <div class="col-6">
                ...
                <div class="row" style="margin-left: 300px;margin-top: -145px;">
                ...
                <div class="row" v-if="DetailProductData.quantityonhand != 0" style="margin-left: 300px;margin-top: -90px;">
                    <p @click="addtoCart(DetailProductData.title)" id="cart_btn" style="cursor:pointer; color: blue;"><i class="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng</p>
                </div>
            </div>
        </div>
        ...
        <!-- Description Product -->
        <div class="row mt-5" id="description" style="margin-left: 20px;">
